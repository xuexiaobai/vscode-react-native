...
export class PackageJsonWatcher {
    ...
    private dropDebuggerStub(): void {
        let debuggerEntryPath = require.resolve("../debugger/debugger");
...
try {
    ...
    var Debugger = require(${JSON.stringify(debuggerEntryPath)}).Debugger;
    new Debugger.Launcher(path.resolve(__dirname, "..")).launch();
} catch (e) {
    throw new Error("Unable to launch application. Try deleting .vscode/launchReactNative.js and restarting vscode.");
        ...
        let fsUtil = new Node.FileSystem();
